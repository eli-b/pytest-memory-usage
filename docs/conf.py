# -*- coding: utf-8 -*-
#
# pytest-memory-usage documentation build configuration file, created by
...
project = u'pytest-memory-usage'
copyright = u'2015, Eli Boyarski'
author = u'Eli Boyarski'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-memory-usage Documentation',
     [author], 1)
]
